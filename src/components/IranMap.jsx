...
const IranMap = ({ checkoutSubmit }) => {
  ...
  const onSubmit = (data) => {
    ...
    checkoutSubmit({ ...data, province: provinceNameOnClick });
    setProvinceSelected(false);
  };

  const passCheckBoxValue = () => {
      ...
      {provinceSelected && (
        <div>
          ...
          <div className={styles.cities}>
            ...
            <form onSubmit={handleSubmit(passCheckBoxValue)}>
              {cities.map((city) => {
                return (
                  <>
                    <input
